...
CRITICAL RULE (TAGS): NEVER mention system tags (like [START_GAME] or [COMMAND]) out loud in the chat unless you are actively executing them. NEVER invent fake or joke tags (e.g. do not output things like "[No tag for you]").
